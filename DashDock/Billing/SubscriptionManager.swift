...
final class SubscriptionManager {
    ...
    func openCheckout() {
        billingError = nil
        guard let checkoutURL = PolarConfig.checkoutURL else {
    ...
    private func validateLicenseKey(_ key: String) async {
        guard let organizationID = PolarConfig.organizationID else {
        ...
        do {
            ...
            if let expectedBenefitID = PolarConfig.expectedBenefitID, response.benefitID != expectedBenefitID {
